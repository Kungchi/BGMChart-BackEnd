...
# Connect to MongoDB
mongoCollection = mongoClient['Genre']['Folk']
...
for i in range(1, 101, 50):
    # URL to scrape
    url = f"https://www.melon.com/genre/song_list.htm?gnrCode=GN0800&steadyYn=Y#params%5BgnrCode%5D=GN0100&params%5BdtlGnrCode%5D=&params%5BorderBy%5D=NEW&params%5BsteadyYn%5D=Y&po=pageObj&startIndex={i}"
    print(url)
