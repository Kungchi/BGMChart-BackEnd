...
for i in range(1, 101, 50):
    # URL to scrape
    url = f"https://www.melon.com/genre/song_list.htm?gnrCode=GN0600#params%5BgnrCode%5D=GN0600&params%5BdtlGnrCode%5D=&params%5BorderBy%5D=NEW&params%5BsteadyYn%5D=N&po=pageObj&startIndex={i}"
    print(url)
...
subprocess.run(['sudo', 'python3', '/home/ubuntu/BGM_Back/Genre/Trot.py'])